...
--------------------------------------------------------------------------------
    --  Image Functions
--------------------------------------------------------------------------------
    function Load_Image (Path : in String) return Image;

    procedure Free_Image (Which : in Image);
...
--------------------------------------------------------------------------------
    --  Font Functions
--------------------------------------------------------------------------------
    function Load_Font (Path : in String; Size : in Positive) return Font;

    procedure Free_Font (Which : in Font);

    function Render_Text (
        Which : in Font;
        Text : in String;
        Blended : in Boolean;
        Foreground : in Colour := (255, 0, 0, 0)) return Image;
